...
function App() {
  ...
  const whatsappMessage = 'Olá! Gostaria de fazer uma reserva na Vulcani Pizzeria.';
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-12">
        ...
        <div className="animate-fade-in opacity-0-start mb-8">
          <img 
            ...
            alt="Vulcani Pizzeria Napoletana" 
        ...
        {/* Social Links */}
        <div className="animate-fade-in-up opacity-0-start delay-1000 flex items-center gap-8">
          <a 
        ...
        <div className="absolute bottom-8 left-0 right-0 text-center">
          <p className="text-white/40 text-xs tracking-widest uppercase">
            Vulcani Pizzeria Napoletana © {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </div>
